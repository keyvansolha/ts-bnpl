...
ts_test_assert_contains( '1326×400', $html, 'Final CTA manager recommends the same desktop banner artwork as the top slider' );
ts_test_assert_contains( '1300×975', $html, 'Final CTA manager keeps a separately composed mobile banner size' );
ts_test_assert_contains( 'عنوان، توضیح و دکمه باید داخل خود تصویر طراحی شوند', $html, 'Final CTA manager states that banner copy lives inside the artwork' );
